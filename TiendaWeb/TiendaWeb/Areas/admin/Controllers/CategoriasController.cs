...
namespace TiendaWeb.Areas.admin.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vm = new CategoriasIndexViewModel
            {
        ...
        public async Task<IActionResult> Create(CategoriaCreateViewModel Crear)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(CategoriaEditViewModel Editar)
        {
            if (!ModelState.IsValid)
            {
                var vm = new CategoriasIndexViewModel
                ...
                TempData["AbrirModalEditar"] = Editar.CategoriaId.ToString();
                return View("Index", vm);
            }
