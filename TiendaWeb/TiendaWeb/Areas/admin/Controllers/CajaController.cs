...
namespace TiendaWeb.Areas.admin.Controllers
{
    ...
    public class CajaController : Controller
    {
        ...
        public CajaController(ICajaService svc) => _svc = svc;

        [HttpGet]
        public async Task<IActionResult> Index()
        {
            ViewData["Title"] = "Cajas";
            var vm = new CajasIndexViewModel
            {
        ...
        public async Task<IActionResult> Create(CajaCreateViewModel Crear)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(CajaEditViewModel Editar)
        {
            if (!ModelState.IsValid)
            {
                var vm = new CajasIndexViewModel
                ...
                TempData["AbrirModalEditar"] = Editar.CajaId.ToString();
                return View("Index", vm);
            }
